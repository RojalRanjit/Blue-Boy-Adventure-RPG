...
public class MON_SkeletonLord extends Entity {
    ...
    public void getAttackImage(){
        ...
        if (inRage == false) {
            ...
            attackDown1 = setup("/monster/skeletonlord_attack_down_2", gp.tileSize*i, gp.tileSize*i*2);
        ...
        if (inRage == true) {
            ...
            attackDown1 = setup("/monster/skeletonlord_phase2_attack_down_2", gp.tileSize*i, gp.tileSize*i*2);
